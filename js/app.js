...
Enemy.prototype.collision = function(x2, y2, h2, w2) {
    if (this.x + this.w < x2 || x2 + w2 < this.x || this.y + this.h < y2 || y2 + h2 < this.y)
        return false;
    else
        return true;
};
...
Enemy.prototype.update = function(dt) {
    ...
    if (this.collision(playerPosition.x, playerPosition.y, 40, 60)) {
